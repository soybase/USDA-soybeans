...
There are three apps that have been constructed to address different components of the analysis: CNV, SNP, genealogy. The apps can be accessed from the [soybase web site](http://www.soybase.org). 
